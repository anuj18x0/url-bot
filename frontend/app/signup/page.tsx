  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="flex flex-1 items-center justify-center px-6 py-12 lg:px-16">
        ...
        >
          ...
          <p className="mt-1.5 text-sm text-muted-foreground">
            Start shortening URLs with AI intelligence
          </p>
      ...
      <div className="relative hidden flex-1 flex-col justify-between overflow-hidden bg-foreground p-10 text-background lg:flex">
        ...
        <motion.div
          className="pointer-events-none absolute -right-24 -top-24 h-[500px] w-[500px] rounded-full opacity-20 blur-[100px]"
          style={{
            background:
              "radial-gradient(circle, oklch(0.7 0.2 330), transparent 70%)",
          }}
          animate={{ scale: [1, 1.15, 1], y: [0, 15, 0] }}
          transition={{ duration: 16, repeat: Infinity }}
        />
        <motion.div
          className="pointer-events-none absolute -bottom-24 -left-24 h-[400px] w-[400px] rounded-full opacity-15 blur-[80px]"
          style={{
            background:
        ...
        <div className="relative z-10 max-w-md">
          ...
          >
            Let an AI agent handle your URLs — just tell it what you need
            in plain English.
          </motion.p>
          ...
          >
            {[
              { icon: BrainCircuitIcon, text: "Gemini-powered AI agent" },
              { icon: GlobeIcon, text: "Real Bitly short links" },
              { icon: ZapIcon, text: "Instant QR codes & analytics" },
            ].map((item) => (
